export const CONTENT = {
  ...
  pricing: {
    ...
    subtext: 'Choose the plan that fits your scale. All plans include a 14-day free trial.',
    badge: 'MOST POPULAR',
    monthly: 'Monthly',
    annual: 'Annual',
    annualDiscount: '-20%',
    ...
    ctaHighlighted: 'Start Free Trial',
    currencyLabel: 'Select currency',
  },
  bentoAccordion: {
    label: 'Platform Features',
    headline: 'Built for Scale',
    subtext: 'Everything you need to build powerful data automation pipelines.',
  },
} as const;
